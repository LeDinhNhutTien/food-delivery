...
function UserManagement() {
    ...
    useEffect(() => {
        fetch('http://localhost:8080/api/rootDiary/all')  // Update with your actual backend URL
                ...
                <div id="content-wrapper" className="d-flex flex-column">
                    <div id="content">
                        ...
                        <div className="container-fluid">
                            <h1 className="h3 mb-2 text-gray-800">Nhật ký làm việc</h1>
                                ...
                                <div className="card-body">
                                    <div className="table-responsive">
                                        <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0">
                                            ...
                                            {diaries.map((diarie) => (
                                                <tr key={diarie.id}>
                                                    <td>{diarie.lastName}</td>
                                                    <td>{diarie.firstName}</td>
                                                    <td>{diarie.content}</td>
                                                    <td>{diarie.createDate}</td>
